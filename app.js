...
const UUIDS = [
'436df3a6-e163-4c90-860a-944bf431be0c',
'1391a569-a3d0-4ecf-a3b5-988de2668546',
'b6c9aa7a-b0ac-4eec-abf4-23c69293cf18',
];

// 订阅地址后缀（这里需要修改一下，可以随便输入一些字母或数字）
const SUB_PATH = 'ofvujlzkvdueq701';

// XHTTP 路径（这里需要修改一下，可以随便输入一些字母或数字）
const XPATH = 'HsaLma5iT4yCS';
